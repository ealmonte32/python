...
# this is to keep track of the errors, we start with 0
error_count = 0
...
while balance > 0:
    print(" (Current errors:", error_count, "out of 3)")
    
    # we check if max errors has been reached, if so, game exits
    if error_count == 3:
        print("\nYou have reached the maximum number of errors.\nThe program will exit.\r")
        break
    ...
    scrolling_coin_flip("OO00||00O", 1)
